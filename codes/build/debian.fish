function debian
    logger "Building debian-stable amd64"
    ...
    logger "Building debian-stable arm64"
    if sudo distrobuilder build-lxc debian.yaml -o image.architecture=arm64 -o image.release=bullseye -o image.variant=default -o source.url="http://mirrors.bfsu.edu.cn/debian"
